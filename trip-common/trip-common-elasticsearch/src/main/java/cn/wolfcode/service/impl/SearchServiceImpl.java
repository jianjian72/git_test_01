...
public class SearchServiceImpl implements ISearchService {
    ...
    @Override
    public <T> Page<T> searchWithHighlight(Class<?> esclz, Class<T> dtoclz, BaseQuery qo, ElasticsearchTypeParser<T> parser, String... fields) {
        //高亮显示
        /*"query":{
            "multi_match": {
                "query": "广州",
        ...
        for (SearchHit<?> searchHit : searchHits) { // 获取搜索到的数据
            // 具体解析操作: 交给外部调用者去实现
            T content = parser.parse(dtoclz, searchHit.getId());
