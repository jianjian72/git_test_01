var vue = new Vue({
    ...
    methods:{
        ...
        init:function (){
            var options = {
                url: getServiceUrl("article") + "/destinations/query",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(value, row, index) {
                            var actions = [];
                            actions.push('<a title="编辑" onclick="vue.editDest(' + row.id + ', \'' + row.info + '\')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> ')
